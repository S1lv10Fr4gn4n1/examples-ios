...
int main(int argc, char *argv[])
{
    ...
    SDL_SetRenderDrawColor(renderer, bg_color.r, bg_color.g, bg_color.b, bg_color.unused);
    ...
    while (SDL_WaitEvent(&event)) {
        ...
        case SDL_KEYDOWN:
            ...
            if (scancode == SDL_SCANCODE_DELETE) {
                ...
                numChars++;
                drawCursor();
                lastCharWasColon = (event.key.keysym.scancode == SDL_SCANCODE_SEMICOLON && (event.key.keysym.mod & KMOD_SHIFT));
            }
